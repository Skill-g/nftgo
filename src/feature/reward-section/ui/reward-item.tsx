...
export function RewardItem ({place}: {place: number}): JSX.Element {
    return (
        <div key={place} className=" bg-gradient-to-b from-[#6100FF80] to-[#B384FF80] rounded-xl p-2 text-center">
            <div className="flex justify-center items-center bg-gradient-to-b  from-[#383838] to-[#585858] rounded-[50px] pl-2
             pr-1 pt-0.5 w-[40px] text-center items-center gap-1 mb-2">
